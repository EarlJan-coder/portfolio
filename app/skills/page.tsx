    ...
    <div className="min-h-screen bg-background py-12 px-6">
      <div className="max-w-6xl mx-auto">
                  ...
                  <Card variant="default" className="h-full">
                    <div className="p-6 sm:p-8">
                      ...
                      <div className="flex items-center gap-4 mb-8">
                        <div
                          className={`w-12 h-12 rounded-xl ${colors.bg} ${colors.text} border border-accent/10 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300`}
                        >
                          {category.icon}
                        </div>
                        <div>
                          <h3 className="text-xl font-bold text-text-primary leading-tight">{category.label}</h3>
                          <span className="text-xs font-bold text-text-muted uppercase tracking-widest">{category.skills.length} skills</span>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-wrap gap-2.5">
                        {category.skills.map((skill, skillIndex) => (
                          ...
                          >
                            <span className="px-3 py-1.5 rounded-full bg-white border border-border text-sm font-medium text-text-secondary hover:border-accent hover:text-accent hover:shadow-sm transition-all cursor-default">
                              {skill}
                            </span>
                          </motion.span>
                        ))}
        ...
        <ScrollReveal delay={0.4} className="mt-20">
          <div className="text-center p-12 rounded-[32px] bg-white border border-border shadow-soft">
            <h3 className="text-3xl font-extrabold text-text-primary mb-4">Always Learning</h3>
            ...
            <a
              ...
              className="inline-flex items-center gap-3 bg-text-primary text-white font-bold px-8 py-4 rounded-full shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all active:scale-95"
            >
